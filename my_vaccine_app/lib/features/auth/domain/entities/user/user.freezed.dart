...
class _$UserImpl implements _User {
  ...
  @override
  String toString() {
    return 'User(id: $id, email: $email, firstName: $firstName, secondName: $secondName, firstLastName: $firstLastName, secondLastName: $secondLastName, roles: $roles, token: $token, expiration: $expiration)';
  }
...
abstract class _User implements User {
  factory _User(
      ...
      final List<String>? roles,
      final String? token,
      final DateTime? expiration}) = _$UserImpl;
